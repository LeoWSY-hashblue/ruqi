...
- ISSUE-001: `/test` path filtering is too broad in `RepoOps.get_relevant_py_files()` and can exclude legitimate repositories or fixtures whose absolute path happens to contain that substring. Deferred to W1.
